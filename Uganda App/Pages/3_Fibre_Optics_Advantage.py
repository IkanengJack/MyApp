...
st.subheader("Fiber optics offers several advantages over traditional methods of data transmission, such as copper wiring. Here are some key advantages of fiber optics:")
